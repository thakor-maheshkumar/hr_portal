  ...
  @if ($auth)
    <div class="home-main-block">
      <?php 
        ...
        $des =  App\DescriptiveQuestion::where('topic_id',$topic->id)->first();
        $optional=App\OptionalMultiple::where('topic_id',$topic->id)->first();
        //dd($optionnal);

      ?>
       @if(!empty($users))
          <div class="alert alert-danger">
              You have already given this test. <a href="{{url('/')}}"> Click here </a>to go back.
          </div>
       @else
       @if($que)
         @if($topic->title == 'English Test')
         From a Grammar perspective, for the questions below, choose the most appropriate option to complete the statement.
         @endif
         @if($topic->title == 'Emotional Quotient Test')
         For the questions below, choose the reaction or step that you are most likely to take in the given situation.
         @endif
      ...
      @if($des)
      <div id="question_block" class="question-block">
       <descriptive :topic_id="{{$topic->id}}" ></descriptive>
      </div>
      @endif
      @if($optional)
      <div id="question_block" class="question-block">
        <optional :topic_id="{{$topic->id}}"></optional>
      </div>
      @endif
      @endif
      @if(empty($que)&&empty($des)&&empty($optional))
      <div class="alert alert-danger">

...
@section('content')
  <div class="margin-bottom">
    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#createModal">Add Test</button>
  </div>
  <!-- Create Modal -->
  <div id="createModal" class="modal fade" role="dialog">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        {!! Form::open(['method' => 'POST', 'action' => 'TopicController@store','id'=>'addtest']) !!}
          <div class="modal-body">
            <div class="row">
              <div class="col-md-6">
                ...
                <div class="form-group{{ $errors->has('per_q_mark') ? ' has-error' : '' }}">
                  {!! Form::label('per_q_mark', 'Passing Marks') !!}
                  <span class="required">*</span>
                  {!! Form::number('passing_marks', null, ['class' => 'form-control', 'placeholder' => 'Please Enter Passing Marks', 'required' => 'required']) !!}
                  <small class="text-danger">{{ $errors->first('passing_marks') }}</small>
                </div>
                ...
                <label for="married_status">Test Price:</label>
                ...
                <div style="display: none;" id="doabox">
                   <br>
                  <label for="dob">Choose Test Price: </label>
                  <div class="form-group{{ $errors->has('amount') ? ' has-error' : '' }}">
                <input value="" name="amount" id="doa" type="text" class="form-control"  placeholder="Please Enter Test Price">
              ...
              <div class="form-group {{ $errors->has('show_ans') ? ' has-error' : '' }}">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="test_type" required="">
                    ...
                    <option value="2">Optional + Multiple Marks</option>
                  </select>
                <br>
              </div>
              </div>
              <div class="col-md-6">
                <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                  ...
                  {!! Form::textarea('description', null, ['class' => 'form-control', 'placeholder' => 'Please Enter Test Description', 'rows' => '8']) !!}
          ...
          @if ($topics)
            ...
            @foreach ($topics as $topic)
              <tr>
                ...
                <td style="text-indent:50px">{{$topic->per_q_mark}}</td>
                <td>{{$topic->timer}} mins</td>
                <td>
                  <!-- Edit Button -->
                  <a type="button" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#{{$topic->id}}EditModal"><i class="fa fa-edit"></i> Edit</a>
                  <!-- Delete Button -->
              ...
              <div id="{{$topic->id}}EditModal" class="modal fade" role="dialog">
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    {!! Form::model($topic, ['method' => 'PATCH', 'action' => ['TopicController@update', $topic->id,'id'=>'edittest']]) !!}
                      <div class="modal-body">
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
                          ...
                          <label for="doba">Choose Test Price: </label>
                          <div class="form-group{{ $errors->has('amount') ? ' has-error' : '' }}">
                           <input value="{{ $topic->amount }}" name="amount" id="doa" type="text" class="form-control"  placeholder="Please Enter Test Price">
                           <small class="text-danger">{{ $errors->first('amount') }}</small>
                          </div>
                        </div>
                        <div class="form-group">
                            <label for="">Select Test Type: </label>
                            <select class="form-control" name="test_type" required="">
                              <option value="0" {{ $topic->test_type == 0 ? 'selected' : '' }}>Optional</option>
                              <option value="1" {{ $topic->test_type == 1 ? 'selected' : '' }}>Descriptive</option>
                              <option value="2" {{ $topic->test_type == 2 ? 'selected' : '' }}>Optional+Multiple Marks</option>
                            </select>
                          <br>
                        </div>
                            </div>

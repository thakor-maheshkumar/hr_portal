  ...
  <div class="dashboard-block">
    <div class="row">
      <div class="col-md-7">
        <div class="row">
          <div class="col-md-6">
            <div class="small-box" style="background-color: #a2b23a;">
              <div class="inner">
                <h3>{{$user}}</h3>
          ...
          <div class="col-md-6">
            ...
            <p>Deletes All Candidate Results</p>
            <!-- All Delete Button -->
      ...
      <div class="col-md-5">
        <div class="box box-danger">
          <div class="box-header with-border">
            <h4 class="box-title">Latest Candidates</h4>
          ...
          <div class="box-footer text-center">
            <a href="{{url('admin/users')}}" class="uppercase">View All Candidates</a>
          </div>

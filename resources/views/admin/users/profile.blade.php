            ...
            <div class="row">
              <div class="col-md-6">
                ...
                <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                  ...
                  <span toggle="#password-field" class="fa fa-fw fa-eye field-icon toggle-password fielddata"></span>
                </div>
          ...
          {!! Form::model($auth, ['method' => 'PATCH', 'action' => ['UsersController@update', $auth->id]]) !!}
            <div class="row">
              <div class="col-md-6">
                ...
                <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                  {!! Form::label('password', 'Password') !!}
                  {!! Form::password('password', ['class' => 'form-control', 'required' => 'required', 'placeholder'=>'Password','id'=>'password-field']) !!}
                  <small class="text-danger">{{ $errors->first('password') }}</small>
                   <span toggle="#password-field" class="fa fa-fw fa-eye field-icon toggle-password fielddata"></span>
                </div>

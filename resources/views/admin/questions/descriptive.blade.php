@extends('layouts.admin', [
  'page_header' => 'Descriptive Test Scoring',
  'dash' => '',
  'quiz' => '',
  'users' => '',
  'questions' => '',
      ...
      @foreach ($topics as $key => $topic)
        <div class="col-md-4">
          <div class="quiz-card">
            ...
            <div class="row">
              ...
              <div class="col-xs-6">
                <ul class="topic-detail right">
                  ...
                  <li>
                    @if($topic->descriptive_questions_count==0)
                    0
                    @else
            ...
            <a href="{{route('questions.show', $topic->id)}}" class="btn btn-primary">Add Questions</a>
